            ...
            (t = document.querySelector("#kt_file_manager_list")) && (o = document.querySelector('[data-kt-filemanager-template="upload"]'),
                ...
                document.getElementById("kt_file_manager_new_folder").addEventListener("click", (n => {
                    ...
                    d.addEventListener("click", (t => {
                        t.preventDefault(),
                            d.setAttribute("data-kt-indicator", "on"),
                            p && p.validate().then((function (t) {
                                console.log("validated!"),
                                    "Valid" == t ? setTimeout((function () {
                                        const t = document.createElement("a");
                                        t.setAttribute("href", "?page=apps/file-manager/blank"),
                                        ...
                                        for (var n, l = e.row(0).index(), i = e.data().length - 1, s = e.row(i).data(), c = i; c > l; c--)
                                            n = e.row(c - 1).data(),
                                                e.row(c).data(n),
                                                e.row(c - 1).data(s);
                                        toastr.options = {
