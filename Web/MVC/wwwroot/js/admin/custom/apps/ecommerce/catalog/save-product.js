...
var KTAppEcommerceSaveProduct = function () {
    ...
    return {
        init: function () {
            let discountSlider, discountLabel;
            ...
            discountSlider = document.querySelector("#kt_ecommerce_add_product_discount_slider");
            discountLabel = document.querySelector("#kt_ecommerce_add_product_discount_label");
            ...
            discountSlider.noUiSlider.on("update", function (values, handle) {
                discountLabel.innerHTML = Math.round(values[handle]);
            });
